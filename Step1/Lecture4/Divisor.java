    ...
    public static ArrayList<Integer> getDivisors(int a){
        ...
        for(int i=1;i<=Math.sqrt(a);i++){
            if(a%i==0){
                ...
                //If we blindly add both i and a / i, we'd add 4 twice, leading to duplicates in the list.
                //The condition if (i != a / i) ensures that we only add a / i if it is different from i, preventing duplicates.
                    divisors.add(a/i);
                }
            }
        }
